    ...
    <div className="pt-28 pb-24 px-[8vw]">
      ...
      <div className="grid grid-cols-1 gap-3 pt-8 border-t structural-rule">
        <div className="flex items-center gap-3">
          ...
          <a href="tel:9415801655" className="font-heading text-xl font-light text-foreground hover:text-primary transition-colors">
            (941) 580-1655
          </a>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <a href="mailto:Contact.AdamLester@gmail.com" className="font-heading text-xl font-light text-foreground hover:text-primary transition-colors">
